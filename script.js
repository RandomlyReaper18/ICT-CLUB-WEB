function notifyUser() {
  ...
  alertDiv.appendChild(document.createTextNode("Welcome to SVNHS ICT CLUB WEBSITE!"));
...
const API_KEY = "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"; // Paste your API key here
